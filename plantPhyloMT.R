...
df = read.table("MTFull22.txt", sep="\t", header=T)
...
write.table(df, "MTspeciesHits.txt", quote=FALSE, row.names=FALSE, sep = "\t",na="")
write.tree(tree,file = "mt-pruned-plantPhylo.phy")
